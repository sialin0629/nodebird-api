...
const Hashtag = require('./hashtag'); // Hashtage 모델 불러오기
const env = process.env.NODE_ENV || 'development'; // 현재 환경 설정
const config = require('../config/config')[env]; // 환경 설정파일 불러오기
...
db.Hashtag = Hastag; / Hashtag 모델을 db 객체에 추가
...
Hashtage.associate(db); // Hashtag 모델의 연관 관계 설정
*/
